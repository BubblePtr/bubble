...
- 实现基础 REPL 循环（已有 ~2000 行代码，在此 crate 中）
...
- **框架**：Astro + Starlight（专为文档设计，开箱即用的 UI）
- **交互组件**：Astro / React 组件（步进式执行流程动画）
- **架构图**：Mermaid.js（Starlight 原生支持）
- **代码示例**：从 `crates/` 源文件直接 include，不手动维护

### 代码 include 模式

```mdx
---
// book/src/content/docs/ch01-repl.mdx
---
import { Code } from '@astrojs/starlight/components';
import repl from '../../../../crates/core/src/repl.rs?raw';

<Code code={repl} lang="rust" />
```
...
- 实现为 Astro/React 组件，本地状态管理（useState）
